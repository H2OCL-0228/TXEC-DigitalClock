// 此处代码需要兼容Internet Explorer浏览器，以保证报错正常显示
try {
...
!function verify() {
  try {
    ...
    ifwarn(navigator.userAgent.match("Trident"), "Internet Explorer浏览器过于老旧，不保证功能的可用性。我们推荐使用Chrome或Edge等浏览器。");
    // ifwarn(location.host != "exam.thisis.host", "您可能在使用第三方或离线的晚修时钟，无法保证内容时效性。<u><a href='https://exam.thisis.host'>点击访问晚修时钟在线官网 exam.thisis.host</a></u>");
    ifwarn(SP.fromold, "检测到跳转自旧网址，请勿依赖此方式访问晚修时钟。建议收藏本页或在晚修时钟菜单内下载快捷方式。");
    ifwarn(SP.debug, "您目前处于" + SP.debug + "倍时间流速的科目检查(调试)模式。<u><a href='?'>点击返回正常模式</a></u>");
  }
  catch (e) {
    alert("检测到非法篡改，请将此代码发送给QQ 3586638355或962613283\n" + e);
    if (confirm("是否访问在线晚修时钟官网 exam.thisis.host ?")) location.href = "https://exam.thisis.host";
  }
